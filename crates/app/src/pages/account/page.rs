...
pub fn AccountPage() -> impl IntoView {
    ...
    let href_profile =
        move || lp(i18n.get_locale(), td_string!(i18n.get_locale(), routes.account_profile_path));
    let href_password =
        move || lp(i18n.get_locale(), td_string!(i18n.get_locale(), routes.account_password_path));
    let href_webauthn =
        move || lp(i18n.get_locale(), td_string!(i18n.get_locale(), routes.account_webauthn_path));
